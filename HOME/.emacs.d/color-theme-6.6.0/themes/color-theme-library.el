...
Includes custom, fl, font-lock, gnus, message, widget."
  ...
  (color-theme-install
   '(color-theme-dark-laptop
     ...
     (message-separator-face ((t (:foreground "blue3"))))
     (modeline ((t (:background "red" :foreground "black"))))
     (modeline-buffer-id ((t (:background "red" :foreground "black"))))
     (modeline-mousable ((t (:background "red" :foreground "black"))))
     (modeline-mousable-minor-mode ((t (:background "red" :foreground "black"))))
     (region ((t (:background "blue"))))
     (primary-selection ((t (:background "blue"))))
     (isearch ((t (:background "blue"))))
     ...
     (widget-documentation-face ((t (:foreground "lime green"))))
     (widget-field-face ((t (:background "dim gray"))))
     (widget-inactive-face ((t (:foreground "red"))))
     (widget-single-line-field-face ((t (:background "dim gray")))))))
